...
export const StatsTab = ({ showToast, showConfirmation }) => {
  ...
  const handleReset = useCallback(() => {
    showConfirmation({
      ...
      message: "Are you sure you want to reset all statistics? This will clear your total count, today's count, and all tracking data. This action cannot be undone.",
