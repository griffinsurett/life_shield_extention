    ...
    <div className="bg-white rounded-2xl shadow-lg p-8 animate-fade-in">
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 bg-gray-50 rounded-xl">
          ...
          <p className="text-sm text-gray-600 mb-4">Where to redirect when blocked content is detected in URLs</p>
          <input 
            type="url" 
        ...
        <div className="p-6 bg-gray-50 rounded-xl">
          ...
          <p className="text-sm text-gray-600 mb-4">How to handle blocked content visually</p>
          <div className="flex gap-4">
            <label className="flex-1 cursor-pointer">
              ...
              <div className="p-4 border-2 border-gray-300 rounded-xl peer-checked:border-primary peer-checked:bg-primary/5 transition-all">
                ...
                <div className="text-sm text-gray-600 mt-1">Completely remove blocked content</div>
              </div>
            </label>
            <label className="flex-1 cursor-pointer">
              <input 
              ...
              <div className="p-4 border-2 border-gray-300 rounded-xl peer-checked:border-primary peer-checked:bg-primary/5 transition-all">
                ...
                <div className="text-sm text-gray-600 mt-1">Blur blocked content instead</div>
              </div>
            </label>
          </div>
        </div>
