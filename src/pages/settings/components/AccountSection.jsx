...
export const AccountSection = ({ showToast }) => {
  ...
  // Get plan name (for now, just free/pro placeholder)
  const getPlanName = () => {
    // You can enhance this based on your Supabase user metadata
    return 'Free Plan';
  };
  ...
  return (
    <div className="p-4">
      <div className="relative">
        ...
        {/* Dropdown Menu */}
        {showDropdown && (
          <div className="absolute bottom-full left-0 right-0 mb-2 bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden animate-slide-up">
            ...
            <div className="p-2">
              ...
              <button
                onClick={() => {
                  ...
                  showToast('Pro plans coming soon!', 'info');
                  setShowDropdown(false);
                }}
