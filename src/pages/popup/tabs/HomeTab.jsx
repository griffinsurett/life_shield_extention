...
export const HomeTab = ({ wordManager, siteManager, showConfirmation }) => {
      ...
      <div className="p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
        ...
        <div className="flex gap-2">
          <Input
            ...
            onKeyPress={(e) =>
              e.key === "Enter" && wordManager.addItem(showConfirmation)
            }
      ...
      <div className="p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
        ...
        <div className="flex gap-2">
          <Input
            ...
            onKeyPress={(e) =>
              e.key === "Enter" && siteManager.addItem(showConfirmation)
            }
